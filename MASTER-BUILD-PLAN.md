...
- [ ] 1.12b **Competitors — the workspace UI**. The routes exist and the export renders; Wally still has no screen to add a competitor on. **DoD:** add/edit/remove from the review workspace, §12.3 checklist in both themes with real seeded data.
